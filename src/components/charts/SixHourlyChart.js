...
class SixHourlyChart extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <g id='sixhourly' ref={g => this.g = g}></g>
        );
    }
    ...
    componentDidMount() {
        ...
        let comp = d3.select("g#sixhourly");
        this.hLineX = 150;
        this.lLineX = 50;
    ...
    drawChart(props) {
        ...
        if (this.xAxis_graph) {
            ...
            let newxAxis = d3.axisTop(props.x)
        ...
        if (this.topbar) {
            ...
            d3.select(".legendeCircleH").attr('cx', this.props.range()[1] - 20);
            d3.select(".legendeCircleN").attr('cx', this.props.range()[1] - 40);
            d3.select(".legendeCircleL").attr('cx', this.props.range()[1] - 60);
            d3.select(".legendeCircText").attr("x", this.props.range()[1] - 110);
            d3.select(".dashLineH_N").attr("x2", this.props.margin.left + this.props.range()[1]);
            d3.select(".dashLineN_L").attr("x2", this.props.margin.left + this.props.range()[1]);
        }
    }
    //circle_color 
    circleColor(d) {
...
export default hot ? hot(module)(SixHourlyChart) : SixHourlyChart;