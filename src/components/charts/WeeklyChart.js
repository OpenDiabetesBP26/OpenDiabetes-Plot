...
drawChart(props) {
    ...
    if (this.xAxis_graph) {
        ...
        // //var readTicks = bg.readTicks(props.x);
        // var opacityArr = bg.creatOpacity();
        // var xPos = bg.creatXpos(props.x);
        // var wdArr = bg.getWds();
    ...
    //         .attr('transform', 'translate(' + this.props.margin.left + ' ' + (this.props.margin.top + 60) + ')');
    // }
    console.log("props.data.basal", props.data.basal)
    /*
    if (this.line != null) {
...
export default hot ? hot(module)(WeeklyChart) : WeeklyChart;